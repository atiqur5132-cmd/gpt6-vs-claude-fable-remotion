...
export const Act5OpenAIAgentsAndAltman: React.FC = () => {
  return (
    <AbsoluteFill style={{ backgroundColor: '#05070E' }}>
      <Series>
        {/* Micro-beat 19: 0-470 (15.7s) -> The Sponsored Agent Paradigm */}
        <Series.Sequence durationInFrames={470}>
          <Beat19SponsoredAgentIntro />
        </Series.Sequence>

        {/* Micro-beat 20: 470-945 (15.8s) -> EVIDENCE TWEET 5: @zaibatsu ChatGPT Ad Agents */}
        ...
        {/* Micro-beat 21: 945-1420 (15.8s) -> Sam Altman Stanford Bombshell */}
        <Series.Sequence durationInFrames={475}>
          <Beat21AltmanStanfordQuote />
        </Series.Sequence>

        {/* Micro-beat 22: 1420-1902 (16.1s) -> GPT-5.5 Sunset Graveyard */}
...
// --- BEAT 21: ALTMAN STANFORD QUOTE ---
const Beat21AltmanStanfordQuote: React.FC = () => {
  return (
    <div style={{ width: '100%', height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '36px 60px', boxSizing: 'border-box' }}>
      <div style={{ width: 1760, height: 820, backgroundColor: '#070B14', border: '1px solid rgba(255,255,255,0.2)', borderRadius: 24, padding: '56px', boxSizing: 'border-box', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', position: 'relative' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          ...
          <span style={{ color: '#94A3B8', fontSize: 14, fontFamily: 'monospace' }}>RECORDED ADDRESS</span>
        </div>

        {/* Massive High-Impact Quote */}
        <div style={{ margin: '32px 0' }}>
          <div style={{ color: '#64748B', fontSize: 72, fontFamily: 'serif', lineHeight: 0.5 }}>“</div>
          <div style={{ color: '#FFFFFF', fontSize: 60, fontWeight: 900, lineHeight: 1.15, letterSpacing: -0.5 }}>
            You don’t need to write prompts anymore.
          </div>
          <div style={{ color: '#38BDF8', fontSize: 32, fontWeight: 700, marginTop: 24 }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderTop: '1px solid rgba(255,255,255,0.1)', paddingTop: 20 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
            <OpenAILogo size={32} color="#FFFFFF" />
            <span style={{ color: '#FFFFFF', fontSize: 20, fontWeight: 800 }}>SAM ALTMAN // CEO, OPENAI</span>
          </div>
          <span style={{ color: '#94A3B8', fontSize: 16 }}>NEXT STEP: <strong>AUTONOMOUS SUBAGENT SWARMS RUNNING 24/7</strong></span>
        </div>
      </div>
    </div>
  );
